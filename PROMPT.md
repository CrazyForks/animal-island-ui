...
- **JSX component** — `<BackTop visibilityHeight={400} />`. A floating Nook bag icon in the bottom-right corner that appears after scrolling past a threshold. Clicking scrolls smoothly to the top.
...
- Default icon is a 158×136 Nook bag PNG embedded as base64, displayed at 120×120px via `object-fit: contain` (80×80px on mobile).
