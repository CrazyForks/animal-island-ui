...
BackTop:               BackTop (floating Nook bag button, bottom-right, smooth scroll to top)
...
| BackTop 图标            | 默认 Nook 袋 PNG（base64 内嵌）; `width: 120px; height: 120px; object-fit: contain`（桌面端） | 移动端 80×80px; hover `scale(1.08)` + 加深 `drop-shadow` |
