...
A floating back-to-top button that appears in the bottom-right corner after scrolling past a threshold. The default icon is a Nook bag PNG (base64-embedded). Clicking triggers a smooth scroll to the top with an easeInOutQuad animation.
...
interface BackTopProps {
    ...
    icon?: React.ReactNode;              // custom icon, default Nook bag
...
// Default — Nook bag icon, 400px threshold, smooth scroll
<BackTop />
